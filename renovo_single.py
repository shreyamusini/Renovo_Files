...
# Get file list
onlyfiles = [join(args.path, args.vcf)]
...
for file_name in onlyfiles:
    ...
    path_to_an_out = (
	#file_name + "/temporary/" + args.vcf + "." + args.build + "_multianno.txt"
        args.path + "/temporary/" + args.vcf  + "." + args.build + "_multianno.txt"
    )
    #path_to_temp = file_name + "/temporary/"
